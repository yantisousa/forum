<template>
    <v-row>
        <v-col v-if="store.state.usuario.length != []" md="6" sm="12" xs="12" cols="12" class="mx-auto">
            <v-card :title="store.state.usuario.name" :prepend-avatar="store.state.usuario.image"
                variant="outlined" class="bg-grey-lighten-3" style="border: none;">
    ...
    <v-row>
        <v-col md="10" sm="12" xs="12" cols="12" class="mx-auto mb-12">
            <v-col cols="12" class="mt-15  d-block" v-for="post in posts">
